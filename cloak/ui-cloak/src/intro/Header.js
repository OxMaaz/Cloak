  ...
  return (
    <div className='p-4 bg-[#FF5757] px-7'>
      <div className='pb-3 border-b border-[#FDF0EF] border-b-1 px-5 flex justify-between items-center'>
        ...
        <h4 className='cursor-pointer sm:text-[1.2rem] font-semibold underline-offset-4 underline text-[.9rem] hover:font-bold hover:text-white text-[#FDF0EF] ' onClick={() => navigate('/')}>How it works?</h4>

      </div>
        {/* at the bottom of the logo */}
        <div className='sm:p-16 p-10 flex flex-col items-start space-y-4'>
          <h2 className='font-bold sm:text-[1.6rem] text-[1.5rem] text-[#FDF0EF]'>Stay Anonymous with Cloak.</h2>
          <p className='text-[#FDF0EF] text-left break-words  max-w-[400px]'>Exchange Trx and Tokens without revealing your actual address.</p>
          <div className='pt-1'>
